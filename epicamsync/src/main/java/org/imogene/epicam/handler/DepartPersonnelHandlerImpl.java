...
import org.imogene.epicam.domain.dao.DepartPersonnelDao;
...
/**
 * Implements a data handler for the DepartPersonnel 
 * @author Medes-IMPS
 */
public class DepartPersonnelHandlerImpl
		extends
			ImogBeanHandlerImpl<DepartPersonnel>
		implements
			DepartPersonnelHandler {

	@Autowired
	@Qualifier(value = "departPersonnelDao")
	private DepartPersonnelDao dao;

	@Override
	public DepartPersonnel createNewEntity(String id) {
		//TODO handle  with not null constraint values
		DepartPersonnel entity = new DepartPersonnel();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(DepartPersonnel entity, boolean neu) {
	...
	@Override
	protected DepartPersonnelDao getDao() {
		return dao;
	}
