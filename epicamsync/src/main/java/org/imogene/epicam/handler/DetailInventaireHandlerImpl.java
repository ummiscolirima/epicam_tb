...
import org.imogene.epicam.domain.dao.DetailInventaireDao;
...
/**
 * Implements a data handler for the DetailInventaire 
 * @author Medes-IMPS
 */
public class DetailInventaireHandlerImpl
		extends
			ImogBeanHandlerImpl<DetailInventaire>
		implements
			DetailInventaireHandler {

	@Autowired
	@Qualifier(value = "detailInventaireDao")
	private DetailInventaireDao dao;

	@Override
	public DetailInventaire createNewEntity(String id) {
		//TODO handle  with not null constraint values
		DetailInventaire entity = new DetailInventaire();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(DetailInventaire entity, boolean neu) {
	...
	@Override
	protected DetailInventaireDao getDao() {
		return dao;
	}
