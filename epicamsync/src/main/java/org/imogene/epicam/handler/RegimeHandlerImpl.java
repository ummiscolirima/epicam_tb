...
import org.imogene.epicam.domain.dao.RegimeDao;
...
/**
 * Implements a data handler for the Regime 
 * @author Medes-IMPS
 */
public class RegimeHandlerImpl extends ImogBeanHandlerImpl<Regime>
		implements
			RegimeHandler {

	@Autowired
	@Qualifier(value = "regimeDao")
	private RegimeDao dao;

	@Override
	public Regime createNewEntity(String id) {
		//TODO handle  with not null constraint values
		Regime entity = new Regime();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(Regime entity, boolean neu) {
