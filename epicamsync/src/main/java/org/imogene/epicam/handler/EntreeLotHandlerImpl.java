...
import org.imogene.epicam.domain.dao.EntreeLotDao;
...
/**
 * Implements a data handler for the EntreeLot 
 * @author Medes-IMPS
 */
public class EntreeLotHandlerImpl extends ImogBeanHandlerImpl<EntreeLot>
		implements
			EntreeLotHandler {

	@Autowired
	@Qualifier(value = "entreeLotDao")
	private EntreeLotDao dao;

	@Override
	public EntreeLot createNewEntity(String id) {
		//TODO handle  with not null constraint values
		EntreeLot entity = new EntreeLot();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(EntreeLot entity, boolean neu) {
