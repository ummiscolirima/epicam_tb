...
import org.imogene.epicam.domain.dao.DetailReceptionIntrantDao;
...
/**
 * Implements a data handler for the DetailReceptionIntrant 
 * @author Medes-IMPS
 */
public class DetailReceptionIntrantHandlerImpl
		extends
			ImogBeanHandlerImpl<DetailReceptionIntrant>
		implements
			DetailReceptionIntrantHandler {

	@Autowired
	@Qualifier(value = "detailReceptionIntrantDao")
	private DetailReceptionIntrantDao dao;

	@Override
	public DetailReceptionIntrant createNewEntity(String id) {
		//TODO handle  with not null constraint values
		DetailReceptionIntrant entity = new DetailReceptionIntrant();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(DetailReceptionIntrant entity, boolean neu) {
	...
	@Override
	protected DetailReceptionIntrantDao getDao() {
		return dao;
	}
