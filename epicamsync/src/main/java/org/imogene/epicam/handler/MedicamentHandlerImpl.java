...
import org.imogene.epicam.domain.dao.MedicamentDao;
...
/**
 * Implements a data handler for the Medicament 
 * @author Medes-IMPS
 */
public class MedicamentHandlerImpl extends ImogBeanHandlerImpl<Medicament>
		implements
			MedicamentHandler {

	@Autowired
	@Qualifier(value = "medicamentDao")
	private MedicamentDao dao;

	@Override
	public Medicament createNewEntity(String id) {
	...
	@Override
	protected void saveOrUpdate(Medicament entity, boolean neu) {
	...
	@Override
	protected MedicamentDao getDao() {
		return dao;
	}
