...
import org.imogene.epicam.domain.dao.FormationDao;
...
/**
 * Implements a data handler for the Formation 
 * @author Medes-IMPS
 */
public class FormationHandlerImpl extends ImogBeanHandlerImpl<Formation>
		implements
			FormationHandler {

	@Autowired
	@Qualifier(value = "formationDao")
	private FormationDao dao;

	@Override
	public Formation createNewEntity(String id) {
	...
	@Override
	protected void saveOrUpdate(Formation entity, boolean neu) {
