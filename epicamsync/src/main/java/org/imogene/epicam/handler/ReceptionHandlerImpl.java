...
import org.imogene.epicam.domain.dao.ReceptionDao;
...
/**
 * Implements a data handler for the Reception 
 * @author Medes-IMPS
 */
public class ReceptionHandlerImpl extends ImogBeanHandlerImpl<Reception>
		implements
			ReceptionHandler {

	@Autowired
	@Qualifier(value = "receptionDao")
	private ReceptionDao dao;

	@Override
	public Reception createNewEntity(String id) {
	...
	@Override
	protected void saveOrUpdate(Reception entity, boolean neu) {
