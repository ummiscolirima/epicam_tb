...
import org.imogene.epicam.domain.dao.PriseMedicamenteuseDao;
...
/**
 * Implements a data handler for the PriseMedicamenteuse 
 * @author Medes-IMPS
 */
public class PriseMedicamenteuseHandlerImpl
		extends
			ImogBeanHandlerImpl<PriseMedicamenteuse>
		implements
			PriseMedicamenteuseHandler {

	@Autowired
	@Qualifier(value = "priseMedicamenteuseDao")
	private PriseMedicamenteuseDao dao;

	@Override
	public PriseMedicamenteuse createNewEntity(String id) {
		//TODO handle  with not null constraint values
		PriseMedicamenteuse entity = new PriseMedicamenteuse();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(PriseMedicamenteuse entity, boolean neu) {
	...
	@Override
	protected PriseMedicamenteuseDao getDao() {
		return dao;
	}
