...
import org.imogene.epicam.domain.dao.OutBoxDao;
...
/**
 * Implements a data handler for the OutBox 
 * @author Medes-IMPS
 */
public class OutBoxHandlerImpl extends ImogBeanHandlerImpl<OutBox>
		implements
			OutBoxHandler {

	@Autowired
	@Qualifier(value = "outBoxDao")
	private OutBoxDao dao;

	@Override
	public OutBox createNewEntity(String id) {
	...
	@Override
	protected void saveOrUpdate(OutBox entity, boolean neu) {
