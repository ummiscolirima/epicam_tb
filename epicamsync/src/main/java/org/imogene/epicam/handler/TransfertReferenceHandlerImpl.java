...
import org.imogene.epicam.domain.dao.TransfertReferenceDao;
...
/**
 * Implements a data handler for the TransfertReference 
 * @author Medes-IMPS
 */
public class TransfertReferenceHandlerImpl
		extends
			ImogBeanHandlerImpl<TransfertReference>
		implements
			TransfertReferenceHandler {

	@Autowired
	@Qualifier(value = "transfertReferenceDao")
	private TransfertReferenceDao dao;

	@Override
	public TransfertReference createNewEntity(String id) {
		//TODO handle  with not null constraint values
		TransfertReference entity = new TransfertReference();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(TransfertReference entity, boolean neu) {
	...
	@Override
	protected TransfertReferenceDao getDao() {
		return dao;
	}
