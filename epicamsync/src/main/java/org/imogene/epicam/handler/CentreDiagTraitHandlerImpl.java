...
import org.imogene.epicam.domain.dao.CentreDiagTraitDao;
...
/**
 * Implements a data handler for the CentreDiagTrait 
 * @author Medes-IMPS
 */
public class CentreDiagTraitHandlerImpl
		extends
			ImogBeanHandlerImpl<CentreDiagTrait>
		implements
			CentreDiagTraitHandler {

	@Autowired
	@Qualifier(value = "centreDiagTraitDao")
	private CentreDiagTraitDao dao;

	@Override
	public CentreDiagTrait createNewEntity(String id) {
		//TODO handle  with not null constraint values
		CentreDiagTrait entity = new CentreDiagTrait();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(CentreDiagTrait entity, boolean neu) {
	...
	@Override
	protected CentreDiagTraitDao getDao() {
		return dao;
	}
