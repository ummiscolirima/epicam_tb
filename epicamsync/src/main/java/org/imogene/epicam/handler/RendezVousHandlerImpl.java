...
import org.imogene.epicam.domain.dao.RendezVousDao;
...
/**
 * Implements a data handler for the RendezVous 
 * @author Medes-IMPS
 */
public class RendezVousHandlerImpl extends ImogBeanHandlerImpl<RendezVous>
		implements
			RendezVousHandler {

	@Autowired
	@Qualifier(value = "rendezVousDao")
	private RendezVousDao dao;

	@Override
	public RendezVous createNewEntity(String id) {
	...
	@Override
	protected void saveOrUpdate(RendezVous entity, boolean neu) {
	...
	@Override
	protected RendezVousDao getDao() {
		return dao;
	}
