...
import org.imogene.epicam.domain.dao.CasIndexDao;
...
/**
 * Implements a data handler for the CasIndex 
 * @author Medes-IMPS
 */
public class CasIndexHandlerImpl extends ImogBeanHandlerImpl<CasIndex>
		implements
			CasIndexHandler {

	@Autowired
	@Qualifier(value = "casIndexDao")
	private CasIndexDao dao;

	@Override
	public CasIndex createNewEntity(String id) {
		//TODO handle  with not null constraint values
		CasIndex entity = new CasIndex();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(CasIndex entity, boolean neu) {
