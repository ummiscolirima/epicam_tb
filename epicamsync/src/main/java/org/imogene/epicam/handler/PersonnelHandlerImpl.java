...
import org.imogene.epicam.domain.dao.PersonnelDao;
...
/**
 * Implements a data handler for the Personnel 
 * @author Medes-IMPS
 */
public class PersonnelHandlerImpl extends ImogActorHandlerImpl<Personnel>
		implements
			PersonnelHandler {
	...
	@Override
	public Personnel createNewEntity(String id) {
	...
	@Override
	protected void saveOrUpdate(Personnel entity, boolean neu) {
