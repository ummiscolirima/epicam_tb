...
import org.imogene.epicam.domain.dao.QualificationDao;
...
/**
 * Implements a data handler for the Qualification 
 * @author Medes-IMPS
 */
public class QualificationHandlerImpl
		extends
			ImogBeanHandlerImpl<Qualification> implements QualificationHandler {

	@Autowired
	@Qualifier(value = "qualificationDao")
	private QualificationDao dao;

	@Override
	public Qualification createNewEntity(String id) {
	...
	@Override
	protected void saveOrUpdate(Qualification entity, boolean neu) {
	...
	@Override
	protected QualificationDao getDao() {
		return dao;
	}
