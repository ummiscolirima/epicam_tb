...
import org.imogene.epicam.domain.dao.DistrictSanteDao;
...
/**
 * Implements a data handler for the DistrictSante 
 * @author Medes-IMPS
 */
public class DistrictSanteHandlerImpl
		extends
			ImogBeanHandlerImpl<DistrictSante> implements DistrictSanteHandler {

	@Autowired
	@Qualifier(value = "districtSanteDao")
	private DistrictSanteDao dao;

	@Override
	public DistrictSante createNewEntity(String id) {
		//TODO handle  with not null constraint values
		DistrictSante entity = new DistrictSante();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(DistrictSante entity, boolean neu) {
	...
	@Override
	protected DistrictSanteDao getDao() {
		return dao;
	}
