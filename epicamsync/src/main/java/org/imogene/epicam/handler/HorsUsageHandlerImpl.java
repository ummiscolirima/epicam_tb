...
import org.imogene.epicam.domain.dao.HorsUsageDao;
...
/**
 * Implements a data handler for the HorsUsage 
 * @author Medes-IMPS
 */
public class HorsUsageHandlerImpl extends ImogBeanHandlerImpl<HorsUsage>
		implements
			HorsUsageHandler {

	@Autowired
	@Qualifier(value = "horsUsageDao")
	private HorsUsageDao dao;

	@Override
	public HorsUsage createNewEntity(String id) {
		//TODO handle  with not null constraint values
		HorsUsage entity = new HorsUsage();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(HorsUsage entity, boolean neu) {
