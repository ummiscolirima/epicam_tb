...
import org.imogene.epicam.domain.dao.InventaireDao;
...
/**
 * Implements a data handler for the Inventaire 
 * @author Medes-IMPS
 */
public class InventaireHandlerImpl extends ImogBeanHandlerImpl<Inventaire>
		implements
			InventaireHandler {

	@Autowired
	@Qualifier(value = "inventaireDao")
	private InventaireDao dao;

	@Override
	public Inventaire createNewEntity(String id) {
	...
	@Override
	protected void saveOrUpdate(Inventaire entity, boolean neu) {
