...
import org.imogene.epicam.domain.dao.SortieLotDao;
...
/**
 * Implements a data handler for the SortieLot 
 * @author Medes-IMPS
 */
public class SortieLotHandlerImpl extends ImogBeanHandlerImpl<SortieLot>
		implements
			SortieLotHandler {

	@Autowired
	@Qualifier(value = "sortieLotDao")
	private SortieLotDao dao;

	@Override
	public SortieLot createNewEntity(String id) {
		//TODO handle  with not null constraint values
		SortieLot entity = new SortieLot();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(SortieLot entity, boolean neu) {
