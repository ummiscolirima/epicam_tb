...
import org.imogene.epicam.domain.dao.CandidatureFormationDao;
...
/**
 * Implements a data handler for the CandidatureFormation 
 * @author Medes-IMPS
 */
public class CandidatureFormationHandlerImpl
		extends
			ImogBeanHandlerImpl<CandidatureFormation>
		implements
			CandidatureFormationHandler {

	@Autowired
	@Qualifier(value = "candidatureFormationDao")
	private CandidatureFormationDao dao;

	@Override
	public CandidatureFormation createNewEntity(String id) {
		//TODO handle  with not null constraint values
		CandidatureFormation entity = new CandidatureFormation();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(CandidatureFormation entity, boolean neu) {
	...
	@Override
	protected CandidatureFormationDao getDao() {
		return dao;
	}
