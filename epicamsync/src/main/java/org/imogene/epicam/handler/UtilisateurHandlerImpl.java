...
import org.imogene.epicam.domain.dao.UtilisateurDao;
...
/**
 * Implements a data handler for the Utilisateur 
 * @author Medes-IMPS
 */
public class UtilisateurHandlerImpl extends ImogActorHandlerImpl<Utilisateur>
		implements
			UtilisateurHandler {
	...
	@Override
	public Utilisateur createNewEntity(String id) {
	...
	@Override
	protected void saveOrUpdate(Utilisateur entity, boolean neu) {
