...
import org.imogene.epicam.domain.dao.LotDao;
...
/**
 * Implements a data handler for the Lot 
 * @author Medes-IMPS
 */
public class LotHandlerImpl extends ImogBeanHandlerImpl<Lot>
		implements
			LotHandler {

	@Autowired
	@Qualifier(value = "lotDao")
	private LotDao dao;

	@Override
	public Lot createNewEntity(String id) {
	...
	@Override
	protected void saveOrUpdate(Lot entity, boolean neu) {
