...
import org.imogene.epicam.domain.dao.SmsPredefiniDao;
...
/**
 * Implements a data handler for the SmsPredefini 
 * @author Medes-IMPS
 */
public class SmsPredefiniHandlerImpl extends ImogBeanHandlerImpl<SmsPredefini>
		implements
			SmsPredefiniHandler {

	@Autowired
	@Qualifier(value = "smsPredefiniDao")
	private SmsPredefiniDao dao;

	@Override
	public SmsPredefini createNewEntity(String id) {
		//TODO handle  with not null constraint values
		SmsPredefini entity = new SmsPredefini();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(SmsPredefini entity, boolean neu) {
	...
	@Override
	protected SmsPredefiniDao getDao() {
		return dao;
	}
