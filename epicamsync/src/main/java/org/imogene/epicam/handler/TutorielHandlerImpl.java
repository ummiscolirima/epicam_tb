...
import org.imogene.epicam.domain.dao.TutorielDao;
...
/**
 * Implements a data handler for the Tutoriel 
 * @author Medes-IMPS
 */
public class TutorielHandlerImpl extends ImogBeanHandlerImpl<Tutoriel>
		implements
			TutorielHandler {

	@Autowired
	@Qualifier(value = "tutorielDao")
	private TutorielDao dao;

	@Override
	public Tutoriel createNewEntity(String id) {
		//TODO handle  with not null constraint values
		Tutoriel entity = new Tutoriel();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(Tutoriel entity, boolean neu) {
