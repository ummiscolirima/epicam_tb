...
import org.imogene.epicam.domain.dao.DetailReceptionMedicamentDao;
...
/**
 * Implements a data handler for the DetailReceptionMedicament 
 * @author Medes-IMPS
 */
public class DetailReceptionMedicamentHandlerImpl
		extends
			ImogBeanHandlerImpl<DetailReceptionMedicament>
		implements
			DetailReceptionMedicamentHandler {

	@Autowired
	@Qualifier(value = "detailReceptionMedicamentDao")
	private DetailReceptionMedicamentDao dao;

	@Override
	public DetailReceptionMedicament createNewEntity(String id) {
		//TODO handle  with not null constraint values
		DetailReceptionMedicament entity = new DetailReceptionMedicament();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(DetailReceptionMedicament entity, boolean neu) {
	...
	@Override
	protected DetailReceptionMedicamentDao getDao() {
		return dao;
	}
