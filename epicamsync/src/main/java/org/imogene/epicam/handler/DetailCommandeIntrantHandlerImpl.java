...
import org.imogene.epicam.domain.dao.DetailCommandeIntrantDao;
...
/**
 * Implements a data handler for the DetailCommandeIntrant 
 * @author Medes-IMPS
 */
public class DetailCommandeIntrantHandlerImpl
		extends
			ImogBeanHandlerImpl<DetailCommandeIntrant>
		implements
			DetailCommandeIntrantHandler {

	@Autowired
	@Qualifier(value = "detailCommandeIntrantDao")
	private DetailCommandeIntrantDao dao;

	@Override
	public DetailCommandeIntrant createNewEntity(String id) {
		//TODO handle  with not null constraint values
		DetailCommandeIntrant entity = new DetailCommandeIntrant();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(DetailCommandeIntrant entity, boolean neu) {
	...
	@Override
	protected DetailCommandeIntrantDao getDao() {
		return dao;
	}
