...
import org.imogene.epicam.domain.dao.IntrantDao;
...
/**
 * Implements a data handler for the Intrant 
 * @author Medes-IMPS
 */
public class IntrantHandlerImpl extends ImogBeanHandlerImpl<Intrant>
		implements
			IntrantHandler {

	@Autowired
	@Qualifier(value = "intrantDao")
	private IntrantDao dao;

	@Override
	public Intrant createNewEntity(String id) {
		//TODO handle  with not null constraint values
		Intrant entity = new Intrant();
		entity.setId(id);
	...
	@Override
	protected void saveOrUpdate(Intrant entity, boolean neu) {
