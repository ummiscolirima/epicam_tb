...
import org.imogene.epicam.domain.dao.RegionDao;
...
/**
 * Implements a data handler for the Region 
 * @author Medes-IMPS
 */
public class RegionHandlerImpl extends ImogBeanHandlerImpl<Region>
		implements
			RegionHandler {
	...
	@Override
	public Region createNewEntity(String id) {
	...
	@Override
	protected void saveOrUpdate(Region entity, boolean neu) {
