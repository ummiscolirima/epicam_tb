...
import org.imogene.epicam.domain.dao.CommandeDao;
...
/**
 * Implements a data handler for the Commande 
 * @author Medes-IMPS
 */
public class CommandeHandlerImpl extends ImogBeanHandlerImpl<Commande>
		implements
			CommandeHandler {
	...
	@Override
	public Commande createNewEntity(String id) {
	...
	@Override
	protected void saveOrUpdate(Commande entity, boolean neu) {
