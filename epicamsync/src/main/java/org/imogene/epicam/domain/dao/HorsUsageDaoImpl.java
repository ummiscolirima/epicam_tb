...
/**
 * Manage persistence for HorsUsage
 */
public class HorsUsageDaoImpl extends ImogBeanDaoImpl<HorsUsage>
		implements
			HorsUsageDao {

	protected HorsUsageDaoImpl() {
		super(HorsUsage.class);
	}
	...
	@Override
	protected Predicate getFilter(Root<HorsUsage> root, CriteriaBuilder builder) {
