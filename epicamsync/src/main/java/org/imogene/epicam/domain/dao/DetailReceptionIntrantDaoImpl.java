...
/**
 * Manage persistence for DetailReceptionIntrant
 */
public class DetailReceptionIntrantDaoImpl
		extends
			ImogBeanDaoImpl<DetailReceptionIntrant>
		implements
			DetailReceptionIntrantDao {

	protected DetailReceptionIntrantDaoImpl() {
		super(DetailReceptionIntrant.class);
	}
	...
	@Override
	protected Predicate getFilter(Root<DetailReceptionIntrant> root,
