...
/**
 * ImogBean implementation for the entity LaboratoireReference
 * @author MEDES-IMPS
 */
@Entity
public class LaboratoireReference extends ImogEntityImpl {
	...
	public static interface Columns {
		...
		public static final int NATURE_NATIONAL = 0;

		public static final int NATURE_REGIONAL = 1;
	...
	private static final long serialVersionUID = -6436066088129586083L;
	...
	@JoinTable(name = "LieuxDitsLaboratoireReferenceLieuDit", joinColumns = @JoinColumn(name = "laboratoirereference_id", referencedColumnName = "id"), inverseJoinColumns = @JoinColumn(name = "lieudit_id", referencedColumnName = "id"))
	private List<LieuDit> lieuxDits;

	/**
	 * Constructor
	 */
	public LaboratoireReference() {
