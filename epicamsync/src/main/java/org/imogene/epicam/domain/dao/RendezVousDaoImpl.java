...
/**
 * Manage persistence for RendezVous
 */
public class RendezVousDaoImpl extends ImogBeanDaoImpl<RendezVous>
		implements
			RendezVousDao {

	protected RendezVousDaoImpl() {
	...
	@Override
	protected Predicate getFilter(Root<RendezVous> root, CriteriaBuilder builder) {
