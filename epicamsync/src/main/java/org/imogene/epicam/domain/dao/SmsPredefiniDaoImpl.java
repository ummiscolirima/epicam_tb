...
/**
 * Manage persistence for SmsPredefini
 */
public class SmsPredefiniDaoImpl extends ImogBeanDaoImpl<SmsPredefini>
		implements
			SmsPredefiniDao {

	protected SmsPredefiniDaoImpl() {
		super(SmsPredefini.class);
	}
