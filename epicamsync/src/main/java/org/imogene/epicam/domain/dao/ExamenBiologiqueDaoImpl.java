...
/**
 * Manage persistence for ExamenBiologique
 */
public class ExamenBiologiqueDaoImpl extends ImogBeanDaoImpl<ExamenBiologique>
		implements
			ExamenBiologiqueDao {

	protected ExamenBiologiqueDaoImpl() {
		super(ExamenBiologique.class);
	}
	...
	@Override
	protected Predicate getFilter(Root<ExamenBiologique> root,
