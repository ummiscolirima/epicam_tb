...
/**
 * Manage persistence for OutBox
 */
public class OutBoxDaoImpl extends ImogBeanDaoImpl<OutBox> implements OutBoxDao {

	protected OutBoxDaoImpl() {
		super(OutBox.class);
	}
	...
	@Override
	protected Predicate getFilter(Root<OutBox> root, CriteriaBuilder builder) {
