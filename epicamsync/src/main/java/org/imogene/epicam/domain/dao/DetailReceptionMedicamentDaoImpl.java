...
/**
 * Manage persistence for DetailReceptionMedicament
 */
public class DetailReceptionMedicamentDaoImpl
		extends
			ImogBeanDaoImpl<DetailReceptionMedicament>
		implements
			DetailReceptionMedicamentDao {

	protected DetailReceptionMedicamentDaoImpl() {
		super(DetailReceptionMedicament.class);
	}
	...
	@Override
	protected Predicate getFilter(Root<DetailReceptionMedicament> root,
