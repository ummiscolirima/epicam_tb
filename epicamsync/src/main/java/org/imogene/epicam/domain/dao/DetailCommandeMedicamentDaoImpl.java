...
/**
 * Manage persistence for DetailCommandeMedicament
 */
public class DetailCommandeMedicamentDaoImpl
		extends
			ImogBeanDaoImpl<DetailCommandeMedicament>
		implements
			DetailCommandeMedicamentDao {

	protected DetailCommandeMedicamentDaoImpl() {
		super(DetailCommandeMedicament.class);
	}
	...
	@Override
	protected Predicate getFilter(Root<DetailCommandeMedicament> root,
