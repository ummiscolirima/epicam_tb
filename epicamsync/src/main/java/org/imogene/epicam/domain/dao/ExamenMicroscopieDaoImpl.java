...
/**
 * Manage persistence for ExamenMicroscopie
 */
public class ExamenMicroscopieDaoImpl
		extends
			ImogBeanDaoImpl<ExamenMicroscopie> implements ExamenMicroscopieDao {

	protected ExamenMicroscopieDaoImpl() {
		super(ExamenMicroscopie.class);
	}
	...
	@Override
	protected Predicate getFilter(Root<ExamenMicroscopie> root,
