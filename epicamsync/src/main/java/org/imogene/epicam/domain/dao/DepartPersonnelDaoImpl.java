...
/**
 * Manage persistence for DepartPersonnel
 */
public class DepartPersonnelDaoImpl extends ImogBeanDaoImpl<DepartPersonnel>
		implements
			DepartPersonnelDao {

	protected DepartPersonnelDaoImpl() {
		super(DepartPersonnel.class);
	}
