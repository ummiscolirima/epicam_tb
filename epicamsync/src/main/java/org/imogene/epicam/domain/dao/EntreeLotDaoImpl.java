...
/**
 * Manage persistence for EntreeLot
 */
public class EntreeLotDaoImpl extends ImogBeanDaoImpl<EntreeLot>
		implements
			EntreeLotDao {

	protected EntreeLotDaoImpl() {
		super(EntreeLot.class);
	}
	...
	@Override
	protected Predicate getFilter(Root<EntreeLot> root, CriteriaBuilder builder) {
