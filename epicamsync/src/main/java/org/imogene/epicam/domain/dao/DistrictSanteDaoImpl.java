...
/**
 * Manage persistence for DistrictSante
 */
public class DistrictSanteDaoImpl extends ImogBeanDaoImpl<DistrictSante>
		implements
			DistrictSanteDao {

	protected DistrictSanteDaoImpl() {
		super(DistrictSante.class);
	}
