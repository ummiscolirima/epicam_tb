...
/**
 * Manage persistence for ArriveePersonnel
 */
public class ArriveePersonnelDaoImpl extends ImogBeanDaoImpl<ArriveePersonnel>
		implements
			ArriveePersonnelDao {

	protected ArriveePersonnelDaoImpl() {
		super(ArriveePersonnel.class);
	}
