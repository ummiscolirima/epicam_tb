...
<link rel="icon" href="../imogepicamweb/images/logo_16x16.png" type="image/png">
<link type="text/css" rel="stylesheet" href="../Epicamweb.css">
		...
		<div class="login-TopPanel">
			...
			<tr>
				<td align="left" style="vertical-align: middle;padding:5px;" width="20%">
					<img src="../imogepicamweb/images/logoImogene.png">
				</td>
				<td align="right" style="vertical-align: middle;padding:5px;" width="20%">
					<img src="../imogepicamweb/images/logoEPICAM.png">
				</td>
			</tr>
		</table>
		</center>
		...
		<table cellspacing="0" cellpadding="0" class="login-centerPanel">
			<tr>
				...
				<td align="right" style="vertical-align: middle;" width="100px">
					<img src="../imogepicamweb/images/logo_web.png" style="opacity:0.6; filter:alpha(opacity=60)">
				</td>
				-->		
				<td>
					<div>
	...
	<!-- 	for Logos -->
		...
		<table style="text-align: center; height: 281px; width: 25%;" cellpadding="2" cellspacing="2">
			<tbody>
				<tr>
					<td>
						<img style="width: 150px; height: 130px;" id="minsanteLogo" alt="MINSANTE logo" src="../imogepicamweb/images/logoMINSANTE.png">
					</td>
					<td>
						<img style="width: 150px; height: 130px;" id="logoPNLT" alt="PNLT logo" src="../imogepicamweb/images/logoPNLT.png">
					</td>
				</tr>
				<tr>
					<td>
						<img style="width: 150px; height: 130px;" id="uy1Logo" alt="UY1 logo" src="../imogepicamweb/images/logoUY1.png">
					</td>
					<td>
						<img style="width: 150px; height: 130px;" id="cpcLogo" alt="CPC logo" src="../imogepicamweb/images/logoCPC.png">
					</td>
				</tr>
				<tr>
					<td>
						<img style="width: 150px; height: 130px;" id="MEDESlogo" alt="MEDES logo" src="../imogepicamweb/images/logoMedes.png">
					</td>
					<td>
						<img style="width: 150px; height: 130px;" id="prodesoLogo" alt="PRODESO logo" src="../imogepicamweb/images/logoProdeso.png"><br>
					</td>
				</tr>
			</tbody>
		</table>
		...
		<div id="mainContent" align="center">
				<img id="imageTB" alt="Image sur la TB" src="../imogepicamweb/images/tuberculose.png"><br>
		</div>	
