...
import org.imogene.epicam.client.ui.table.CentreDiagTraitDynaTable;
...
/**
 * Panel that contains the CentreDiagTrait Dynatable
 * @author Medes-IMPS
 */
public class CentreDiagTraitListPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, CentreDiagTraitListPanel> {
	}
	...
	@UiField(provided = true)
	CentreDiagTraitDynaTable listComposite;
	 ...
	 */
	public CentreDiagTraitListPanel(EpicamRequestFactory requestFactory,
			String searchText) {
		...
		wrapperPanel.setTitle(NLS.constants().centreDiagTrait_table_text());
		if (EpicamIconConstants.CENTREDIAGTRAIT_ICON != null)
			wrapperPanel.setIcon(EpicamIconConstants.CENTREDIAGTRAIT_ICON);

		/* data provider */
		CentreDiagTraitDataProvider provider = new CentreDiagTraitDataProvider(
				requestFactory);
		...
		if (AccessManager.canDeleteCentreDiagTrait()
			...
			listComposite = new CentreDiagTraitDynaTable(requestFactory,
					provider, true);
		else
			listComposite = new CentreDiagTraitDynaTable(requestFactory,
					provider, false);
	...
	/**
	 * Configures the Data provider that enables to get the data to feed the table that lists CentreDiagTrait entries
	 * @param provider
	 * @param searchText
	 * @return
	 */
	private String configureDataProvider(CentreDiagTraitDataProvider provider,
			String searchText) {
	...
	/**
	 * Configures the Wrapper panel to manage the actions that are related to the table that lists CentreDiagTrait entries
	 */
