...
import org.imogene.epicam.client.ui.table.DetailReceptionMedicamentDynaTable;
...
/**
 * Panel that contains the DetailReceptionMedicament Dynatable
 * @author Medes-IMPS
 */
public class DetailReceptionMedicamentListPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder
			extends
				UiBinder<Widget, DetailReceptionMedicamentListPanel> {
	}
	...
	@UiField(provided = true)
	DetailReceptionMedicamentDynaTable listComposite;
	 ...
	 */
	public DetailReceptionMedicamentListPanel(
		...
		wrapperPanel.setTitle(NLS.constants()
				.detailReceptionMedicament_table_text());
		if (EpicamIconConstants.DETAILRECEPTIONMEDICAMENT_ICON != null)
			wrapperPanel
					.setIcon(EpicamIconConstants.DETAILRECEPTIONMEDICAMENT_ICON);

		/* data provider */
		DetailReceptionMedicamentDataProvider provider = new DetailReceptionMedicamentDataProvider(
				requestFactory);
		...
		/* dynatable */
		if (AccessManager.canDeleteDetailReceptionMedicament()
				&& AccessManager.canEditDetailReceptionMedicament())
			listComposite = new DetailReceptionMedicamentDynaTable(
	...
	/**
	 * Configures the Data provider that enables to get the data to feed the table that lists DetailReceptionMedicament entries
	 * @param provider
	 * @param searchText
	 * @return
	 */
	private String configureDataProvider(
			DetailReceptionMedicamentDataProvider provider, String searchText) {
	...
	/**
	 * Configures the Wrapper panel to manage the actions that are related to the table that lists DetailReceptionMedicament entries
	 */
