...
/**
 * ImogBean implementation for the entity DistrictSante Backup
 * @author MEDES-IMPS
 */
@Entity
@Table(name = "DistrictSante_Bck")
public class DistrictSanteBck extends ImogBeanBck {

	private static final long serialVersionUID = -1791886827917989899L;
